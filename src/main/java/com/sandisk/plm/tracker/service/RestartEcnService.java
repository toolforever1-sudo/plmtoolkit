...
public class RestartEcnService {
     ...
     *  references, optionally followed by " — note". Vikas's rule: just the ECN
     *  number(s) — e.g. {@code "ECN-0245719"} or {@code "ECN-0245719, ECN-0245801"};
     *  the filename is NOT appended (the Filename column already shows it).
     *  ({@code filename} kept for call-site compatibility; unused.) */
