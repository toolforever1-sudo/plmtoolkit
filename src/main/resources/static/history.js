...
var HISTORY_LIFECYCLE_PILLS = ['DEV','PROTO','PPROD','C-ACT','ACT','MKT','EOL','OBS','OBS-SKU','DEAD'];
...
var LIFECYCLE_ORDER = ['DEV', 'PROTO', 'PPROD', 'C-ACT', 'ACT', 'MKT', 'EOL', 'OBS', 'OBS-SKU', 'DEAD'];
var LIFECYCLE_COLORS = {
    'DEV': '#6c757d', 'PROTO': '#17a2b8', 'PPROD': '#ffc107', 'C-ACT': '#20c997',
    'ACT': '#28a745', 'MKT': '#4a6fa5', 'EOL': '#fd7e14', 'OBS': '#dc3545',
