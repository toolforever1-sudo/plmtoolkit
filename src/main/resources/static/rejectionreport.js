...
function rrCss() {
    return [
        ...
        '.rr-btn{height:30px;padding:0 11px;background:#fff;border:1px solid #E8E6DF;border-radius:6px;font-size:12.5px;color:#3a4150;cursor:pointer;display:inline-flex;align-items:center;gap:6px;}',
        '.rr-btn:hover{background:#FAFAF7;border-color:#dcdad2;}',
        '.rr-btn.primary{background:#0F1720;color:#fff;border-color:#0F1720;}.rr-btn.primary:hover{background:#222a36;}',
