...
function triRender() {
    ...
    var html = ''
        ...
        + '    </div>'
        + '    <button class="tool-btn" onclick="triGenerateClick()" style="background:#1a3a5c; color:#fff; font-weight:600;">Generate Team Report &rarr;</button>'
        + '  </div>'
        + '</div>'
        ...
        + '  <button class="tool-btn" onclick="triGenerateClick()" style="background:#1a3a5c; color:#fff; font-weight:600; padding:9px 22px; font-size:13.5px;">Generate Team Report &rarr;</button>'
...
function triAiGridHtml() {
    ...
    if (!d.analysis || d.analysis.length === 0) {
        ...
        return '<div style="padding:34px 18px; text-align:center; color:#6B7280;">'
            ...
            + '</p>'
            + '<button class="tool-btn" onclick="triRegenerateAi(true)" style="background:#1a3a5c; color:#fff; font-weight:600; padding:8px 18px; font-size:13px;">Generate AI Analysis</button>'
